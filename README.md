...
- adds RSI-specific fast exit protection for the live USDJPY RSI route: RSI-managed positions can move to breakeven after 10 minutes and 5 pips of favorable movement, then trail after 8 pips with a 3.5-pip distance. This is scoped to `QG_RSI_Rev` comments so the MA live route keeps its original slower breakeven/trailing behavior.
