...
This uses the Auto Scheduler plan as the source queue and still defaults to config-only. Do not add `--run-terminal` unless you are inside an authorized Strategy Tester window or explicit authorization session.
