...
def build_parser() -> argparse.ArgumentParser:
    ...
    sample.add_argument("--symbols", default=argparse.SUPPRESS)
    sample.set_defaults(func=cmd_sample)
    status = sub.add_parser("status")
    status.add_argument("--symbols", default=argparse.SUPPRESS)
    status.set_defaults(func=cmd_status)
    quality = sub.add_parser("quality")
    quality.add_argument("--symbols", default=argparse.SUPPRESS)
    quality.add_argument("--no-write", action="store_true")
    quality.set_defaults(func=cmd_quality)
    text = sub.add_parser("telegram-text")
    text.add_argument("--symbols", default=argparse.SUPPRESS)
