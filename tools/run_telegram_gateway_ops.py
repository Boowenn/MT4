...
try:
    ...
    from telegram_gateway_ops.status import build_gateway_ops_status, collect_gateway_ops
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "collect":
        return emit(collect_gateway_ops(runtime_dir, repo_root=repo_root, refresh=not args.no_refresh))
