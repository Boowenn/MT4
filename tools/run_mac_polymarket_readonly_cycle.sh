...
PRESERVE_RUN_CANARY_EXECUTOR_SET="${QG_POLYMARKET_RUN_CANARY_EXECUTOR+x}"
PRESERVE_RUN_CANARY_EXECUTOR_VALUE="${QG_POLYMARKET_RUN_CANARY_EXECUTOR:-}"
PRESERVE_CANARY_EXECUTOR_PLAN_ONLY_SET="${QG_POLYMARKET_CANARY_EXECUTOR_PLAN_ONLY+x}"
PRESERVE_CANARY_EXECUTOR_PLAN_ONLY_VALUE="${QG_POLYMARKET_CANARY_EXECUTOR_PLAN_ONLY:-}"
PRESERVE_CANARY_EXIT_PLAN_ONLY_SET="${QG_POLYMARKET_CANARY_EXIT_MONITOR_PLAN_ONLY+x}"
PRESERVE_CANARY_EXIT_PLAN_ONLY_VALUE="${QG_POLYMARKET_CANARY_EXIT_MONITOR_PLAN_ONLY:-}"

restore_explicit_executor_overrides() {
  if [[ -n "$PRESERVE_RUN_CANARY_EXECUTOR_SET" ]]; then
    export QG_POLYMARKET_RUN_CANARY_EXECUTOR="$PRESERVE_RUN_CANARY_EXECUTOR_VALUE"
  fi
  if [[ -n "$PRESERVE_CANARY_EXECUTOR_PLAN_ONLY_SET" ]]; then
    export QG_POLYMARKET_CANARY_EXECUTOR_PLAN_ONLY="$PRESERVE_CANARY_EXECUTOR_PLAN_ONLY_VALUE"
  fi
  if [[ -n "$PRESERVE_CANARY_EXIT_PLAN_ONLY_SET" ]]; then
    export QG_POLYMARKET_CANARY_EXIT_MONITOR_PLAN_ONLY="$PRESERVE_CANARY_EXIT_PLAN_ONLY_VALUE"
  fi
}
